...
<head>
    ...
    <style>
        ...
        .action-link, .back-link, .add-new-link { color: #007bff; text-decoration: none; font-weight: bold; }
        .action-link:hover, .back-link:hover, .add-new-link:hover { text-decoration: underline; }
...
<body>
    ...
    <main>
        <div class="content-container">
            ...
            <p><a href="index.php" class="back-link">Back to Dashboard</a> | <a href="add_product.php" class="add-new-link">Add New Product</a></p>
