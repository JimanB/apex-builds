    ...
    <main>
        <div class="content-container">
            ...
            <ul class="help-menu">
                ...
                <li><a href="accounts-and-orders.php">User Accounts & Orders</a></li> <li><a href="understanding-components.php">Understanding PC Components</a></li>
                <li><a href="changing-themes.php">How to Change Website Themes</a></li>
                <li><a href="contact-and-support.php">Contacting Support</a></li>
                <li><a href="for-site-admins.php">For Site Admins: How to Update Products</a></li>
                <li><a href="admin-guide.php">Administrator's Guide</a></li> </ul>
            </ul>
        </div>
    </main>
