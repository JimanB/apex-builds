...
<head>
    ...
    <title>Solid State Drives (SSDs) | Apex Builds</title>
    <meta name="description"
        content="Get lightning-fast load times with our selection of NVMe Gen4 Solid State Drives (SSDs).">
    <meta name="keywords" content="ssd, solid state drive, nvme, gen4, storage">
